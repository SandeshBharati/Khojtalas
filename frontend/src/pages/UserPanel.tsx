...
import { ref, update, get, query as rtdbQuery, orderByChild, equalTo } from 'firebase/database';
...
export default function UserPanel() {
  ...
  const fetchUserItems = async () => {
    ...
    try {
      const q = rtdbQuery(ref(db, 'items'), orderByChild('userId'), equalTo(user.uid));
